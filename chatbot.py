...
try:
    ...
    data = {
        ...
        "emotions": ["I'm sad", "I'm happy", "I'm angry", "I'm excited"],
        "emotions_responses": ["I'm here for you!", "That's great to hear!", "Take a deep breath!", "That's exciting!"],
        "general_knowledge": ["who are you?", "what is your name?", "what can you do?", "tell me about yourself"],
        "general_knowledge_responses": ["I'm a chatbot made to chat with you!", "You can call me ChatBot!", "I can answer your questions and chat!"]
    }
...
def get_response(user_input):
    ...
    vectorizer = CountVectorizer().fit_transform([user_input] + all_phrases)
